...
import { FaMapMarkerAlt,  FaPhoneAlt, FaEnvelope, FaUserAlt, FaPencilAlt } from "react-icons/fa";
                                    ...
                                    <div className="map40">
                                        <div className="map-address">
                                            ...
                                            <ul className="address-info">
                                                <li><span><FaMapMarkerAlt /></span>1234 Address, City Goes Here</li>
                                                <li><span><FaPhoneAlt /></span>(xx) 123 456 789 | (xx) 123 456 789 </li>
                                                <li><span><FaEnvelope /></span>email@golfasia.dk</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
a message</h5>
                                        ...
                                        <Col md={6}>
                                            ...
                                            <Button className="btn-orange-sendmg mr-0 ml-auto" >Send Message</Button>
                    ...
                    <div className="container">
                        <div className="copyright text-uppercase">
                            <ul className="foot-menu">
                                ...
                                <li><a href="#">Golf With Hotel</a></li>
                                <li><a href="#">Golf Courses & Rates</a></li>
                ...
                <a href="#" className="uparoow"><FaAngleUp/></a>
            </div>
        )
    }
}
